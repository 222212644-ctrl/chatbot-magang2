    ...
    links: [
      {
        ...
        description:
          "Data statistik kesehatan dan fasilitas kesehatan Kota Medan",
      },
    ],
  },
};
...
export const handleChatbotQuery: RequestHandler = async (req, res) => {
  try {
    ...
    const matchedKey = Object.keys(searchDatabase).find(
      ...
      response = {
        ...
        links: [
          ...
          },
          {
            ...
            description:
              "Daftar publikasi dan laporan statistik BPS Kota Medan",
          },
        ],
      };
    }
